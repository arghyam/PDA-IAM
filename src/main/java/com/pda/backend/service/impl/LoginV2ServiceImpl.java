...
import com.pda.backend.service.LoginV2Service;
        ...
        CompletableFuture.runAsync(
                () -> {
                    try {
                        ...
                        sendOTP(keycloakUser, Constants.REGISTRATION_KEYWORD, "Thanks for  registering with PDA. Your verification code is " + otp + ". Kindly verify your mobile number.", otp);
    ...
    public ResponseDTO updatePhoneNumberVerification(String phoneNumber, String accessToken, String countryCode) {
        ...
        try {
            ...
            if (null != user.getEmail() && !user.getEmail().isEmpty()) {
                ...
                CompletableFuture.runAsync(() -> {
                    try {
                        sendOTP(user, Constants.UPDATE_PHONE_KEYWORD, "Thanks for registering with PDA. Your verification code is " + otp + ". Kindly verify your mobile number.", otp);
                    } catch (Exception e) {
